...
#titulo de la raiz
titulo = Label(ventanaPrincipal, text="Convertidor de monedas", font=("Roboto",20,"bold"))
titulo.grid(row=1, column=1, padx=10, columnspan=2)

#Etiqueta moneda actual
titulo = Label(ventanaPrincipal, text="Numero A", font=("Roboto",10,"bold"))
...
#moneda actual
titulo = Label(ventanaPrincipal, text="Valor actual", font=("Roboto",10,"bold"))
